  ...
  return (
    ...
    >
      ...
      <p className="text-lg font-medium text-primary mt-4">
        Our experts are charting your course...
      </p>
    </MotionDiv>
  );
}
    ...
    <section className="py-20 md:py-28 bg-transparent">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <SpotlightCard className="max-w-4xl mx-auto">
          <Card className="relative z-10 bg-card/60 backdrop-blur-xl border-primary/50 shadow-2xl shadow-primary/10 overflow-hidden">
            <form action={dispatch}>
              <CardHeader>
                ...
                <CardDescription>
                  Tell us about your goals, and our AI will suggest the best
                  training programs for you.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-8">
                <div className="space-y-2">
                  <Label htmlFor="careerGoals" className="text-lg">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="beginner">
                        Beginner (No prior flight experience)
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="intermediate" id="intermediate" />
                      <Label htmlFor="intermediate">
                        Intermediate (Some flight hours / PPL)
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="experienced" id="experienced" />
                      <Label htmlFor="experienced">
                        Experienced (CPL or higher)
                      </Label>
                    </div>
                  </RadioGroup>
                  {state.errors?.experienceLevel && (
                    <p className="text-sm text-destructive">
                      {state.errors.experienceLevel[0]}
                    </p>
                  )}
                </div>
              </CardContent>
            ...
            {state.recommendation && (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-headline text-2xl text-green-400">
